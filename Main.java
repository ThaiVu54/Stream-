...
public class Main {
    public static void main(String[] args) {
        ...
        // String th = "cbbd";
        // System.out.println("chuỗi đối xứng dài nhất: "+ s.longestPalindrome(th));
        ...
        // System.out.println("chuỗi zigzagConversion: " + zigzagConversion.convert(aa,
        // 4));
    ...
    private static void aggregatingOperationsExamples() {
        List<String> words = Arrays
                .stream("Once upon a midnight dreary while I pondered weak and weary".split("\\s+"))
                .collect(Collectors.toList());
    ...
    private static void moreFunnyExamples() {
        List<String> words = Arrays
                .stream("These examples cover only a small part of Java 8 Streams.".split("\\s+"))
                .collect(Collectors.toList());
        ...
        System.out.println("reduce o day: "+production);
